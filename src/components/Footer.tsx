...
function BMCLogo() {
  return (
    <svg width="88" height="25" viewBox="0 0 143 41" fill="none" aria-label="BMC Group">
      ...
      <path d="M47.1533 11.4279C47.642 11.7885 48.0369 12.0771 48.4246 12.3728C50.3813 13.8624 52.3415 15.3483 54.2819 16.8577C54.4759 17.0272 54.5951 17.2663 54.6137 17.5232C54.6293 25.1682 54.636 32.8138 54.6336 40.4599C54.6336 40.8459 54.5326 40.9811 54.1268 40.9775C51.9496 40.9595 49.7717 40.9595 47.5933 40.9775C47.211 40.9775 47.1118 40.8459 47.1118 40.4834C47.119 30.9737 47.119 21.4653 47.1118 11.9581C47.119 11.8246 47.1352 11.693 47.1533 11.4279Z" fill="#1A1A1A"/>
    </svg>
  )
}
...
// ─── Data ─────────────────────────────────────────────────────────────────────
const CONTACTS = [
  { Icon: MessageCircle, text: 'WhatsApp: +972 50-000-0000', color: 'rgba(37,211,102,1)', weight: 500 },
  { Icon: Phone,         text: '+972 50-000-0000',            color: '#64748b',            weight: 400 },
  { Icon: Mail,          text: 'info@bmcgroup.co.il',         color: '#64748b',            weight: 400 },
  { Icon: MapPin,        text: 'Тель-Авив · Хайфа · Онлайн', color: '#64748b',            weight: 400 },
]

const NAV = [
  {
    heading: 'Компания',
    links: ['Услуги', 'Видео', 'Отзывы', 'Кейсы', 'FAQ', 'Контакты'],
  },
  {
    heading: 'Калькуляторы',
    links: ['Ипотечный калькулятор', 'Сравнение банков', 'Рефинансирование', 'Анализ бюджета'],
  },
  {
    heading: 'База знаний',
    links: ['Виды ипотеки', 'Государственные программы', 'Ипотека для олим', 'Налоги на недвижимость'],
  },
]
...
export default function Footer() {
  return (
    <footer style={{
      ...
      <div className="px-4 md:px-[100px]" style={{ maxWidth: 1353, margin: '0 auto', paddingTop: 48 }}>
        ...
        >
          ...
          {NAV.map(({ heading, links }) => (
            <div key={heading} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
              <p style={{
                fontFamily: 'Inter, system-ui, sans-serif',
                fontSize: 13, fontWeight: 500,
                color: '#94a3b8', lineHeight: '20px',
                margin: 0, marginBottom: 16,
                textTransform: 'uppercase', letterSpacing: '0.05em',
              }}>
                {heading}
              </p>
              <nav style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 10 }}>
                {links.map((link) => (
                  <a key={link} href="#" className="footer-link footer-link--dark">{link}</a>
                ))}
              </nav>
            </div>
          ))}
